package cn.codeyang.yang.module.crm.controller.admin.product.vo.product;
...
public class CrmProductRespVO implements VO {
    ...
    @Trans(type = TransType.SIMPLE, targetClassName = "cn.codeyang.yang.module.system.dal.dataobject.user.AdminUserDO",
