...
import cn.codeyang.yang.module.infra.dal.mysql.logger.ApiErrorLogMapper;
import cn.codeyang.yang.module.infra.enums.logger.ApiErrorLogProcessStatusEnum;
...
import static cn.codeyang.yang.module.infra.enums.ErrorCodeConstants.API_ERROR_LOG_NOT_FOUND;
import static cn.codeyang.yang.module.infra.enums.ErrorCodeConstants.API_ERROR_LOG_PROCESSED;
...
public class ApiErrorLogServiceImplTest extends BaseDbUnitTest {
    ...
    public void testGetApiErrorLogPage() {
        ...
        ApiErrorLogDO apiErrorLogDO = randomPojo(ApiErrorLogDO.class, o -> {
            ...
            o.setApplicationName("yang-test");
            o.setRequestUrl("foo");
        ...
        reqVO.setApplicationName("yang-test");
