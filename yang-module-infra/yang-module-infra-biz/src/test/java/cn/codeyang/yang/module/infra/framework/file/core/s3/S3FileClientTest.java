package cn.codeyang.yang.module.infra.framework.file.core.s3;
...
//        config.setAccessSecret(System.getenv("QINIU_SECRET_KEY"));
        ...
        config.setDomain("http://test.yang.iocoder.cn"); // 如果有自定义域名，则可以设置。http://static.yang.iocoder.cn
        // 默认上海的 endpoint
