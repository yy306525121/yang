package cn.codeyang.yang.module.infra.service.codegen.inner;
...
import cn.codeyang.yang.framework.apilog.core.enums.OperateTypeEnum;
...
import cn.codeyang.yang.framework.excel.core.annotations.DictFormat;
import cn.codeyang.yang.framework.excel.core.convert.DictConvert;
import cn.codeyang.yang.framework.excel.core.util.ExcelUtils;
import cn.codeyang.yang.framework.mybatis.core.dataobject.BaseDO;
...
public class CodegenEngine {
    ...
    private static String javaModuleFilePath(String path, String module, String src) {
        return "yang-module-${table.moduleName}/" + // 顶级模块
                "yang-module-${table.moduleName}-" + module + "/" + // 子模块
                "src/" + src + "/java/${basePackage}/module/${table.moduleName}/" + path + ".java";
    }

    private static String mapperXmlFilePath() {
        return "yang-module-${table.moduleName}/" + // 顶级模块
                "yang-module-${table.moduleName}-biz/" + // 子模块
    ...
    private static String vueFilePath(String path) {
        return "yang-ui-${sceneEnum.basePackage}-vue2/" + // 顶级目录
                "src/" + path;
    }
    ...
    private static String vue3FilePath(String path) {
        return "yang-ui-${sceneEnum.basePackage}-vue3/" + // 顶级目录
                "src/" + path;
    }
