package cn.codeyang.yang.module.infra.controller.admin.logger.vo.apiaccesslog;
...
public class ApiAccessLogRespVO {
    ...
    @DictFormat(cn.codeyang.yang.module.infra.enums.DictTypeConstants.OPERATE_TYPE)
