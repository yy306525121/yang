package cn.codeyang.yang.module.infra.dal.dataobject.logger;
...
public class ApiErrorLogDO extends BaseDO {
     ...
     * 处理用户编号
     *
     * 关联 cn.codeyang.yang.adminserver.modules.system.dal.dataobject.user.SysUserDO.SysUserDO#getId()
     */
