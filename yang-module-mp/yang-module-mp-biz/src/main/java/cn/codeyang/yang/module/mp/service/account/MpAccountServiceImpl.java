package cn.codeyang.yang.module.mp.service.account;
...
import cn.codeyang.yang.module.mp.convert.account.MpAccountConvert;
import cn.codeyang.yang.module.mp.dal.dataobject.account.MpAccountDO;
import cn.codeyang.yang.module.mp.dal.mysql.account.MpAccountMapper;
import cn.codeyang.yang.module.mp.enums.ErrorCodeConstants;
...
import static cn.codeyang.yang.module.system.enums.ErrorCodeConstants.USER_USERNAME_EXISTS;
    ...
    public void initLocalCache() {
        ...
        TenantUtils.executeIgnore(() -> {
            ...
            try {
                ...
                log.error("[微信公众号 yang-module-mp - 表结构未导入][参考 https://doc.iocoder.cn/mp/build/ 开启]");
            }
