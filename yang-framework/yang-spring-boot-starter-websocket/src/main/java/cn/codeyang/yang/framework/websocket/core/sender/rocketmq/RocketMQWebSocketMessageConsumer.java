package cn.codeyang.yang.framework.websocket.core.sender.rocketmq;
...
@RocketMQMessageListener( // 重点：添加 @RocketMQMessageListener 注解，声明消费的 topic
        topic = "${yang.websocket.sender-rocketmq.topic}",
        consumerGroup = "${yang.websocket.sender-rocketmq.consumer-group}",
