 ...
 *      1）Spring Async：
 *          {@link cn.codeyang.yang.framework.quartz.config.YangAsyncAutoConfiguration#threadPoolTaskExecutorBeanPostProcessor()}
 *      2）Spring Security：
 *          TransmittableThreadLocalSecurityContextHolderStrategy
 *          和 YangSecurityAutoConfiguration#securityContextHolderMethodInvokingFactoryBean() 方法
 *
 */
package cn.codeyang.yang.framework.tenant;
