package cn.codeyang.yang.module.system.service.user;

import cn.hutool.core.util.RandomUtil;
import cn.codeyang.yang.framework.common.enums.CommonStatusEnum;
import cn.codeyang.yang.framework.common.exception.ServiceException;
import cn.codeyang.yang.framework.common.pojo.PageResult;
import cn.codeyang.yang.framework.common.util.collection.ArrayUtils;
import cn.codeyang.yang.framework.common.util.collection.CollectionUtils;
import cn.codeyang.yang.framework.test.core.ut.BaseDbUnitTest;
import cn.codeyang.yang.module.infra.api.config.ConfigApi;
import cn.codeyang.yang.module.infra.api.file.FileApi;
import cn.codeyang.yang.module.system.controller.admin.user.vo.profile.UserProfileUpdatePasswordReqVO;
import cn.codeyang.yang.module.system.controller.admin.user.vo.profile.UserProfileUpdateReqVO;
import cn.codeyang.yang.module.system.controller.admin.user.vo.user.*;
...
import cn.codeyang.yang.module.system.dal.dataobject.dept.UserPostDO;
...
import cn.codeyang.yang.module.system.dal.mysql.dept.UserPostMapper;
import cn.codeyang.yang.module.system.dal.mysql.user.AdminUserMapper;
import cn.codeyang.yang.module.system.enums.common.SexEnum;
import cn.codeyang.yang.module.system.service.dept.DeptService;
import cn.codeyang.yang.module.system.service.dept.PostService;
import cn.codeyang.yang.module.system.service.permission.PermissionService;
import cn.codeyang.yang.module.system.service.tenant.TenantService;
...
import static cn.codeyang.yang.framework.common.util.collection.SetUtils.asSet;
import static cn.codeyang.yang.framework.common.util.date.LocalDateTimeUtils.buildBetweenTime;
import static cn.codeyang.yang.framework.common.util.date.LocalDateTimeUtils.buildTime;
...
import static cn.codeyang.yang.module.system.enums.ErrorCodeConstants.*;
import static cn.codeyang.yang.module.system.service.user.AdminUserServiceImpl.USER_INIT_PASSWORD_KEY;
...
public class AdminUserServiceImplTest extends BaseDbUnitTest {
    ...
    public void before() {
        // mock 初始化密码
        when(configApi.getConfigValueByKey(USER_INIT_PASSWORD_KEY)).thenReturn("yangyuanma");
    }
    ...
    public void testCreatUser_success() {
        ...
        when(passwordEncoder.encode(eq(reqVO.getPassword()))).thenReturn("yangyuanma");
        ...
        assertEquals("yangyuanma", user.getPassword());
    ...
    public void testImportUserList_02() {
        ...
        when(deptService.getDept(eq(dept.getId()))).thenReturn(dept);
        // mock passwordEncoder 的方法
        when(passwordEncoder.encode(eq("yangyuanma"))).thenReturn("java");
