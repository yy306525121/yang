...
import cn.codeyang.yang.framework.common.util.cache.CacheUtils;
...
import cn.codeyang.yang.module.system.api.social.dto.SocialWxQrcodeReqDTO;
import cn.codeyang.yang.module.system.api.social.dto.SocialWxaSubscribeMessageSendReqDTO;
import cn.codeyang.yang.module.system.controller.admin.socail.vo.client.SocialClientPageReqVO;
import cn.codeyang.yang.module.system.controller.admin.socail.vo.client.SocialClientSaveReqVO;
import cn.codeyang.yang.module.system.dal.dataobject.social.SocialClientDO;
import cn.codeyang.yang.module.system.dal.mysql.social.SocialClientMapper;
import cn.codeyang.yang.module.system.dal.redis.RedisKeyConstants;
...
public class SocialClientServiceImpl implements SocialClientService {
     ...
     * 3. developer：开发版
     */
    @Value("${yang.wxa-code.env-version:release}")
     ...
     * 3. formal：正式版
     */
    @Value("${yang.wxa-subscribe-message.miniprogram-state:formal}")
