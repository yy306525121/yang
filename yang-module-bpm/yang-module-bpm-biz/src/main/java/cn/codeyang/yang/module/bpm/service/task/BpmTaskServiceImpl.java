...
import cn.codeyang.yang.framework.web.core.util.WebFrameworkUtils;
import cn.codeyang.yang.module.bpm.controller.admin.task.vo.task.*;
import cn.codeyang.yang.module.bpm.convert.task.BpmTaskConvert;
import cn.codeyang.yang.module.bpm.dal.dataobject.definition.BpmFormDO;
import cn.codeyang.yang.module.bpm.dal.dataobject.definition.BpmProcessDefinitionInfoDO;
import cn.codeyang.yang.module.bpm.enums.definition.*;
import cn.codeyang.yang.module.bpm.enums.task.BpmCommentTypeEnum;
import cn.codeyang.yang.module.bpm.enums.task.BpmReasonEnum;
import cn.codeyang.yang.module.bpm.enums.task.BpmTaskSignTypeEnum;
...
import cn.codeyang.yang.module.bpm.service.definition.BpmFormService;
import cn.codeyang.yang.module.bpm.service.definition.BpmModelService;
...
import cn.codeyang.yang.module.bpm.service.message.dto.BpmMessageSendWhenTaskTimeoutReqDTO;
...
import static cn.codeyang.yang.module.bpm.framework.flowable.core.enums.BpmnVariableConstants.PROCESS_INSTANCE_VARIABLE_RETURN_FLAG;
import static cn.codeyang.yang.module.bpm.framework.flowable.core.util.BpmnModelUtils.*;
...
public class BpmTaskServiceImpl implements BpmTaskService {
    ...
    public void rejectTask(Long userId, @Valid BpmTaskRejectReqVO reqVO) {
        ...
        // 疑问：为什么要标记未通过呢？
        // 回答：例如说 A 任务被向前加签除 B 任务时，B 任务被审批不通过，此时 A 会被取消。而 yang-ui-admin-vue3 不展示“已取消”的任务，导致展示不出审批不通过的细节。
    ...
    public void processTaskCreated(Task task) {
        ...
        TransactionSynchronizationManager.registerSynchronization(new TransactionSynchronization() {
             ...
             * 参见 <a href="https://gitee.com/zhijiantianya/yang-cloud/issues/IB7V7Q">issue</a> 反馈
             */
            @Override
