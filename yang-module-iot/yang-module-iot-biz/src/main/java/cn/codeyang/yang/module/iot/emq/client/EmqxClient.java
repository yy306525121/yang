package cn.codeyang.yang.module.iot.emq.client;

import cn.codeyang.yang.module.iot.emq.callback.EmqxCallback;
import cn.codeyang.yang.module.iot.emq.config.MqttConfig;
...
public class EmqxClient {
    ...
    private void createMqttClient() {
        try {
            mqttClient = new MqttClient(mqttConfig.getHostUrl(), "yang" + mqttConfig.getClientId(), new MemoryPersistence());
