...
public class ProjectReactor {
    ...
    private static final String GROUP_ID = "cn.codeyang.boot";
    private static final String ARTIFACT_ID = "yang";
    private static final String PACKAGE_NAME = "cn.codeyang.yang";
    private static final String TITLE = "PT管理系统";
    ...
    public static void main(String[] args) {
        ...
        // ========== 配置，需要你手动修改 ==========
        String groupIdNew = "cn.codeyang.boot";
        String artifactIdNew = "yang";
        String packageNameNew = "cn.codeyang.yang";
        String titleNew = "PT管理系统";
