package cn.codeyang.yang.framework.ai.core.factory;
...
import cn.codeyang.yang.framework.ai.config.YangAiAutoConfiguration;
import cn.codeyang.yang.framework.ai.config.YangAiProperties;
...
import cn.codeyang.yang.framework.common.util.spring.SpringUtils;
...
public class AiModelFactoryImpl implements AiModelFactory {
    ...
    public MidjourneyApi getOrCreateMidjourneyApi(String apiKey, String url) {
        ...
        return Singleton.get(cacheKey, (Func0<MidjourneyApi>) () -> {
            YangAiProperties.MidjourneyProperties properties = SpringUtil.getBean(YangAiProperties.class).getMidjourney();
    ...
    /**
     * 可参考 {@link YangAiAutoConfiguration#deepSeekChatModel(YangAiProperties)}
     */
    ...
    /**
     * 可参考 {@link YangAiAutoConfiguration#xingHuoChatClient(YangAiProperties)}
     */
